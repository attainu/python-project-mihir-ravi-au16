...
class snake_ladder:
    ...
    def Snakes(self):
        ...
        if num_of_snakes > 0:
            print(
                "\n Enter head and tail separated by a space, use a new line for each snake.")
            i = 0
            while i < (num_of_snakes):
                ...
                if head < 100 and tail > 0:
                    ...
                    print("Invalid! Snake should lie between 1 to 99")
    ...
    def Ladders(self):
        ...
        if num_of_ladders > 0:
            ...
            print(
                "\n Enter start and end separated by a space, use a new line for each snake.")
            ...
            while i < (num_of_ladders):
                ...
                if start > 0 and end <= 100:
                    ...
                    print("Invalid! Ladder should lie between 1 to 100")
    ...
    def welcome_to_the_game(self):
        ...
        GAME RULES
           1. When a player lands at the head of a snake, he shall reposition himself
              at the tail of that snake.
           2. WHen a player lands at the base of a ladder, he shall reposition
              himself at the top of that ladder.
           3. To win, the player shall roll the exact number on the die to land
              on the number 100. In case the value in the die adds up to a number
              greater than 100, then the player needs to roll the die again in the
              next turn.
